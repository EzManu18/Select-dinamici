var dati = {
    "Emilia Romagna": {
      "Parma": ["Parma", "Fidenza", "Sissa Trecasali"],
      "Reggio Emilia": ["Reggio Emilia", "Correggio", "Scandiano"]
    },
    "Lombardia": {
      "Milano": ["Milano", "Legnano", "Cinisello Balsamo"],
      "Brescia": ["Brescia", "Desenzano", "Gardone"]
    }
  };
  
  window.onload = function() {
    var regioni = Object.keys(dati); // array contenente le chiavi di dati.
    var selectRegione = document.getElementById("regione");
    for(var i = 0; i < regioni.length; i++) { // scorre tutte le regioni
  ...
  function aggiornaProvince() {
    ...
    var province = Object.keys(dati[selectRegione.value]); // array che contiene le provincie in base alla regione
  ...
  function aggiornaComuni() {
    ...
    var comuni = dati[selectRegione.value][selectProvincia.value]; // array che contiene i comuni
